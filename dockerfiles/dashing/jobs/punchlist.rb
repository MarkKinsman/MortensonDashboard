...
base_url = "https://bim360field.autodesk.com/"
...
begin
  ticket = RestClient.post base_url + "api/login", {:params => {:username => username, :password => password}}, {:Authorization => 'Basic bWFyYy5raW5zbWFuQG1vcnRlbnNvbi5jb206S2VybHdnMDg='}
rescue => err
